...
@Autonomous
public class RedMoveFoundation extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        telemetry.addData("Time Spent:", getRuntime());
        telemetry.update();
    ...
    public void moveServo(double angleIntLeft, double angleIntRight){
        robot.leftServo.setPosition(angleIntLeft);
        robot.rightServo.setPosition(angleIntRight);
        sleep(1500);
    }

    public void arcTurnLeft (double leftArcPower){
        robot.FL.setPower(leftArcPower * 0.5);
        robot.FR.setPower(leftArcPower);
        robot.BL.setPower(leftArcPower*0.5);
        robot.BR.setPower(leftArcPower);
    }

    public void arcTurnRight (double rightArcPower){
        robot.FL.setPower(rightArcPower);
        robot.FR.setPower(rightArcPower*0.5);
        robot.BL.setPower(rightArcPower);
        robot.BR.setPower(rightArcPower*0.5);
    }
